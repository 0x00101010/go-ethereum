...
const (
	...
	BlobTxTargetBlobGasPerBlock = 6 * BlobTxBlobGasPerBlob  // Target consumable blob gas for data blobs per block (for 1559-like pricing)
	MaxBlobGasPerBlock          = 12 * BlobTxBlobGasPerBlob // Maximum consumable blob gas for data blobs per block
